...
public class WriteListOfStrings {
    ...
    public static void main(String[] args) throws IOException {
        CSVWriter writer = new CSVWriter(new FileWriter("outputfiles/outputfile_using_list_of_strings.csv"), ICSVWriter.DEFAULT_SEPARATOR, ICSVWriter.NO_QUOTE_CHARACTER, '\t', "\n");
